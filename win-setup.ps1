...
# Windows Updates
# Change updates to "Notify to schedule restart"
...
# Uninstall unecessary apps that come with Windows
...
# Bing Weather, News, Sports, and Finance:
...
# rename the computer
# requires restart, or add -Restart flag
$computername = "Desert"
